...
namespace RecipeBookMVC.Migrations
{
    ...
    [Migration("20260521230634_AddFirstAndLastNameToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RecipeBookMVC.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RecipeBookMVC.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("RecipeBookMVC.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("RecipeBookMVC.Models.Recipe", b =>
                {
                    ...
                    b.HasOne("RecipeBookMVC.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
